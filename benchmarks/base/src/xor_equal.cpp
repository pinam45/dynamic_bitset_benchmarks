...
SUL_DYNAMIC_BITSET_BENCHMARK_RANGE(sul_dynamic_bitset_xor_equal, "^=");
...
BOOST_DYNAMIC_BITSET_BENCHMARK_RANGE(boost_dynamic_bitset_xor_equal, "^=");
#endif
...
STD_TR2_DYNAMIC_BITSET_BENCHMARK_RANGE(std_tr2_dynamic_bitset_xor_equal, "^=");
#endif
...
STD_VECTOR_BOOL_BENCHMARK_RANGE(std_vector_bool_xor_equal, "^=");
...
STD_BITSET_BENCHMARK_RANGE(std_bitset_xor_equal, "^=");
